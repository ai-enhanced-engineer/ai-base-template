...
def test_abbreviate_logger_name_shortens_project_loggers() -> None:
    ...
    from src.logging import _abbreviate_logger_name

    # Test project logger abbreviation
    assert _abbreviate_logger_name("src.core.chat") == "core.chat"
    assert _abbreviate_logger_name("src.services.llm.session") == "llm.session"
    assert _abbreviate_logger_name("src.middleware.logger") == "middleware.logger"
    assert _abbreviate_logger_name("src.api.threads") == "api.threads"

    # Test single component (should use last part)
    assert _abbreviate_logger_name("src.main") == "main"
...
def test_format_extra_fields_prioritizes_important_fields() -> None:
    ...
    from src.logging import _format_extra_fields
